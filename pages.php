					...
					<div class="panel-contents">
						...
						<div class="panel-group editor-toolbar">
							...
							<div class="radio-wrap">
								<input type="radio" id="invisible-table-mode" name="table-mode"/>
								<label id="invisible-table-mode-label" for="invisible-table-mode"><span></span> Invisible Mode</label>
							</div>
							<div class="radio-wrap">
								<input type="radio" id="normal-table-mode" name="table-mode"/>
								<label id="normal-table-mode-label" for="normal-table-mode"><span></span> Normal Mode</label>
							</div>
						</div>
